...
<?php } ?>
                ...
                <section class="content">
                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                ...
                                <div class="panel-body table-responsive">
                                    ...
                                    <?php
                    $query1="select * from trans_pinjam WHERE status='pinjam' ORDER BY id";
                  ...
                  $no=0;
                    ...
                    <tr>
                    <td><?php echo $no;?></td>
                    <td><a href="detail-buku.php?hal=edit&kd=<?php echo $data['id_peminjam'];?>"><span class="fa fa-book"></span> <?php echo $data['judul_buku'];?></a></td>
                    ...
                    <a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Kembali" href="kembali.php?hal=edit&id_trans=<?php echo $data['id'];?>&judul=<?php echo $data['judul_buku'];?>"><span class="glyphicon glyphicon-tags"></span></a>
                    <a class="btn btn-sm btn-success" data-placement="bottom" data-toggle="tooltip" title="Perpanjang" href="perpanjang.php?hal=id_trans=<?php echo $data['id'];?>&judul=<?php echo $data['judul_buku'];?>&kembali=<?php echo $data['tgl_kembali'];?>&lambat=<?php $lambat; ?>"><span class="fa fa-refresh fa-spin"></span></a>
                    </td></tr></div>
                    <?php   
              } 
              ?>
