                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-buku.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  ...
                                  <option value="<?php echo $data['kode_klas']; ?>"> <?php echo $data['kode_klas']; ?></option>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="jum_temp" type="text" id="jum_temp" class="form-control" autocomplete="off" value="<?php echo $data['jum_temp']; ?>" required />
                              </div>
                          </div>
                          <div class="form-group">
