...
tanggallengkap = namahari[hari] + ", " +tanggal + " " + namabulan[bulan] + " " + tahun;
    ...
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
      ...
      <body class="skin-black">
		...
		<b>Selamat Datang di PerPusWeb (Perpustakaan Berbasis Website) Pro Version, Untuk Login Admin silahkan klik Icon User atau klik <a href="login.html">disini</a></b>
          </div>
            </div>
...
<!-- Data Total Pengunjung -->                        
              ...
              <!-- row end -->
                ...
                <div class="footer-main">
                    Copyright &copy <a href="http://www.sarjanakomedi.com" target="_blank">PerPusWeb</a> 2015
                </div>
            </aside><!-- /.right-side -->
